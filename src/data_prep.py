...
# tuple version
EVENTSt = [("Warszawa", 3, 12, 10.00, 110, 1918.04), ("Krakow", 1, 6, 9.00, 100, 1198.91),
           ("Krakow", 14, 21, 9.00, 100, 1198.91), ("Lodz", 8, 13, 8.40, 90, 1113.55),
           ("Lodz", 16, 21, 8.40, 90, 1113.55), ("Wroclaw", 11, 16, 8.00, 100, 967.42),
           ("Wroclaw", 18, 26, 8.00, 100, 967.42), ("Poznan", 3, 10, 8.00, 80, 816.06),
           ("Poznan", 23, 28, 8.00, 80, 816.06), ("Gdansk", 10, 14, 7.80, 80, 800.34),
           ("Gdansk", 18, 23, 7.80, 80, 800.34), ('Szczecin', 7, 12, 7.00, 80, 747.78),
           ("Szczecin", 26, 31, 7.00, 80, 747.78), ("Bydgoszcz", 5, 9, 6.40, 70, 652.41),
           ("Bydgoszcz", 13, 18, 6.40, 70, 652.41), ("Lublin", 1, 6, 6.20, 70, 629.26),
           ("Lublin", 18, 24, 6.20, 70, 629.26), ("Katowice", 4, 9, 6.00, 60, 596.62),
           ("Katowice", 26, 31, 6.00, 60, 596.62)]
fuel_cost = 4.5  # per l
